$PBExportHeader$pbdom_characterdata.sru
forward
global type pbdom_characterdata from pbdom_object
end type
end forward
...
global pbdom_characterdata pbdom_characterdata

on pbdom_characterdata.create
call super::create
TriggerEvent( this, "constructor" )
end on

on pbdom_characterdata.destroy
